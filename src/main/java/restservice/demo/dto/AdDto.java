...
public class AdDto {
    ...
    public AdDto(String make, String model, Number year, Number price, String description, String transmission, Number kilometres, String bodyType, String sellerType) {
        this.make = make;
        this.model = model;
        this.year = year;
        this.price = price;
